...
<ul>
  ...
  <li><a href="{$baseUrl}/index.php/OSMP/pages/view/editorhelpvideos">Need Help? Watch these videos</a></li>
...
<form method="post" id="submit" action="{url path="search"}">
	...
	<input type="text" size="15" name="search" class="textField marginTop" value="{$search|escape}" placeholder="Search Text" />
	<br />
