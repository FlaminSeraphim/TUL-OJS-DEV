...
{/if}
	...
	<tr valign="top" class="marginTopBot">
...
<div class="row">
  ...
  <div class="col-xs-12">
    <input type="button" value="{translate key="common.cancel"}" onclick="document.location.href='{url op="index" escape=false}'" class="btn btn-danger btn-block cancelBtn" />
  </div>
</div>
<p></p>
