...
<tr valign="top">
	...
	<td class="value">
		...
		<input type="file" name="newAttachment" class="uploadField" /> <input name="addAttachment" type="submit" class="btn changeRadius marginTopSm" value="{translate key="common.upload"}" />
	</td>
</tr>
{/if}
{if $isAnEditor}
